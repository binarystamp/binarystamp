...
| `ENS_REVERSE_CACHE_TTL` | no | Seconds to cache a successful reverse lookup (3600) |
| `ENS_REVERSE_MISS_TTL` | no | Seconds to cache a miss (300) — shorter, since a miss can be a transient failure |
