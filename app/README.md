...
BinaryStamp is an on-chain file provenance registry. Users hash files client-side and register the hash on-chain. The system spans EVM (Base), Sui, Walrus, ENS, and The Graph.
